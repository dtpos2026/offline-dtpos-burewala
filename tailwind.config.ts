    ...
    extend: {
      ...
      colors: {
        ...
        pos: {
          ...
          cart: "hsl(var(--pos-cart))",
          grid: "hsl(var(--pos-grid-bg))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
